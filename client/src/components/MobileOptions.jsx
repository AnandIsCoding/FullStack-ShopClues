...
function MobileOptions() {
  ...
  <span className="mt-1 text-xs sm:text-sm font-medium">Account</span>
      ...
      {/* Wishlist */}
      <div  onClick={()=>navigate('/wishlist')} className="flex flex-col items-center justify-center text-[#24A3B5] active:scale-95 transition-transform duration-150 cursor-pointer">
      ...
      {/* Cart */}
      <div  onClick={()=>navigate('/cart')} className="flex flex-col items-center justify-center text-[#24A3B5] cursor-pointer active:scale-95 transition-transform duration-150">
